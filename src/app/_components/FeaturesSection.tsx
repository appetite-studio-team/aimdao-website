...
import { PiFileLock, PiStamp, PiStrategy } from "react-icons/pi";
    ...
    <section className="pt-8 pb-12" id="features-section">
      <div className="mx-auto max-w-6xl px-8">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <FeatureCard
            icon={<PiFileLock className="p-3 text-5xl" />}
          ...
          />
          <FeatureCard
            icon={<PiStamp className="p-3 text-5xl" />}
          ...
          />
          <FeatureCard
            icon={<PiStrategy className="p-3 text-5xl" />}
